...
$(document).ready(function() {
  ...
  var startConversation = function(index) {
    ...
    //console.log(dialog);
    $.post(context + '/dialogs/' + dialog.dialog_id + '/conversation', {input: ''})
    .done(function(data) {
      $conversation.empty();
      $information.empty();
  ...
  var conductConversation = function(){
    ...
    var path = context + '/dialogs/' + conversation.dialog_id + '/conversation';
    var params = {
      input: $userInput.val(),
  ...
  var deleteDialog = function(dialogIndex) {
    ...
    $.ajax({
      type: 'DELETE',
      url: context + '/dialogs/'+ dialog.dialog_id,
      dataType: 'html'
    })
    .done(function(){
  ...
  var getProfile = function() {
    var path = context + '/dialogs/' + conversation.dialog_id + '/profile';
    var params = {
      conversation_id: conversation.conversation_id,
      client_id: conversation.client_id
    };
